...
<?php
	echo "<html><h1>Add Student</h1></html>";
	...
	echo 	"<link href='../CSS/index2.css' rel='stylesheet' type='text/css' /><form method='post' action='addStudent.php'>";
	...
	echo "<br>These are the users in the database.";
